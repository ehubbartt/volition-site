...
export type TaskKind = 'setup' | 'daily' | 'weekly' | 'event' | 'competition' | 'admin' | 'packs';
...
// are still a 'todo' (not done, actionable now) count — 'active'/ongoing items
// (Skill or Kill, bingo, DuoWolf, …) and 'done' items don't.
